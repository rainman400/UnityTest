...
CREATE TABLE `tag` (
  ...
  KEY `game_tag_table_FK_idx` (`game_id`),
  CONSTRAINT `game_tag_table_FK` FOREIGN KEY (`game_id`) REFERENCES `games` (`game_id`)
...
INSERT INTO `tag` VALUES (1,'ssl',1),(2,'tts',1),(3,'sql',2),(9,'this',8),(10,'is',8),(11,'tag',8),(21,'1',20),(22,'2',20),(23,'3',20);
...
-- Dump completed on 2021-06-23  9:22:02
